...
2. Upload `hydrograph_simulation.ipynb` (**File → Upload notebook**).
3. Run all cells (**Runtime → Run all**).
4. Use the sliders in the last cell to explore different `Ip`, `τ`, `k`, and review-time values interactively.
...
jupyter notebook hydrograph_simulation.ipynb
```
...
```
.
├── hydrograph_simulation.ipynb   # Main notebook: model, plotting, interactive widget
├── hydrograph_plot.jpg           # Example output plot
└── README.md
```

## Example Output

With `Ip = 60 m³/s`, `τ = 3.8 hr`, `k = 1.8`, `dt = 0.05 hr`:

| Result | Value |
|---|---|
| Peak Inflow | 60.00 m³/s at t ≈ 2.90 hr |
| Peak Outflow | 48.64 m³/s at t ≈ 3.25 hr |

## License

This project is open-source and available for educational and research use. Feel free to fork, modify, and adapt it for your own hydrological analysis.
